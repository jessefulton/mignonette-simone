/*
 *	miggl.c - Mignonette Game Library, v0.92
 *
...
// convert ratio into "frequency" for audio code in ISR
//
#define R2N(ratio)		(uint16_t)(ratio*128.0+0.5)	
...
//
// XXX need to fill in ALL entries in this table! (just did the common ones)
//
